...
class ExcelAnalyzer:
    def __init__(self):
        self.df = None
        self.verif_col = 'Verivikasi Pengawas'  # Cek nama kolom, bisa ubah ke 'Verifikasi Pengawas' jika typo
    ...
    def calculate_confusion_stats(self):
        ...
        berdasarkan kolom self.verif_col yang harus mengandung nilai "True Positive", "True Negative", "False Positive", "False Negative".
        """
...
def main():
    ...
    sheet_choice = st.sidebar.selectbox(
        "Pilih sheet yang akan digabung dari semua file",
        sheets,
        index=default_index
    )
